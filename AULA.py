...
nome_ =  tk.Label(janela, text = 'NOME', bg='pink', font=('arial',10))
...
texto =  tk.Label(janela, text = 'IDADE', bg='pink', font=('arial',10))
...
email_ =  tk.Label(janela, text = 'EMAIL', bg='pink', font=('arial',10))
email_.grid(row=3, column=0, pady=7)


endereco_ =  tk.Label(janela, text = 'ENDERECO', bg='pink', font=('arial',10))
endereco_.grid(row=4, column=0, pady=8)

celular_ = tk.Label(janela, text = 'CELULAR', bg='pink', font=('arial',10))
